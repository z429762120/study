...
import com.tool.collect.skytools.support.springExtension.resolver.annotation.MapWapper;
import com.tool.collect.skytools.support.springExtension.resolver.annotation.RequestModel;
...
/**
 * 扩展数据绑定，使用方法 company.name company.city
 *
 * @author Gnoll
