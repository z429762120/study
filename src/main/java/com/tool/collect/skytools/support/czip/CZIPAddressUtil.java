package com.tool.collect.skytools.support.czip;
 ...
 * @Descriiption 纯真ip库
 * @Author bo
 * @Date 2019/8/4 上午10:36
 **/
@Data
@Slf4j
public class CZIPAddressUtil {
   ...
   // @PostConstruct
    ...
    public static void main(String[] args){
        ...
        String path = bootPath + "/src/main/resources/qqwry.dat";



        CZIPAddressUtil ip = new CZIPAddressUtil();
        ip.setIP_FILE(path);
        ip.init();
        //String address = "172.16.101.50";
        String address = "125.71.215.141";
