...
public class AlipaySignature {
    ...
    public static String rsa256Sign(String content, String privateKey,
        ...
        try {
            ...
            if (StringUtility.isEmpty(charset)) {
    ...
    public static PrivateKey getPrivateKeyFromPKCS8(String algorithm,
        ...
        if (ins == null || StringUtility.isEmpty(algorithm)) {
            return null;
        }
    ...
    public static String rsaEncrypt(String content, String publicKey,
        ...
        try {
            ...
            byte[] data = StringUtility.isEmpty(charset) ? content.getBytes()
            ...
            return StringUtility.isEmpty(charset) ? new String(encryptedData)
    ...
    public static String rsaDecrypt(String content, String privateKey,
        ...
        try {
            ...
            byte[] encryptedData = StringUtility.isEmpty(charset)
            ...
            return StringUtility.isEmpty(charset) ? new String(decryptedData)
